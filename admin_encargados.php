...
<html>
    ...
    <head>
        ...
        <title>Administración de Encargados de TFG</title>
        ...
        <div id="wrapper">
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Administración de Encargados de TFG</h2>
                        <ol class="breadcrumb">

                            <li class="active">
                                <strong>Consulta de Encargados de TFG</strong>
                            </li>
                            <li>
                                <a data-toggle="modal" href="#modal-form">Registrar Encargado</a>
                            </li>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-title">
                                    <h5>Consulta de Encargados de TFG</h5>
            ...
            $(document).ready(function () {
                ...
                $('.dataTables-example').DataTable({
                    ...
                    buttons: [
                        ...
                        {extend: 'csv',
                            title: 'Reporte encargados '+ getFecha(),
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4, 5]
                            }
                        },
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Agregar Encargado de TFG</h3>
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/TFGagregar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="TFGagregarEncargado" ><strong>Registrar</strong></button>
        ...
        <div id="mod-form" class="modal fade" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Modificar Encargado</h3>
                                ...
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/TFGModificar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-danger pull-left m-t-n-xs" type="button" id="desactivar" name="desactivarEncargado"><i class="fa fa-warning"></i><strong> Desactivar</strong></button>
                                        <button class="btn btn-sm btn-info pull-left m-t-n-xs" type="button" name="activarEncargado" id="activar" ><i class="fa fa-check-circle"></i><strong> Activar</strong></button>
                                        <input name="estado" id="estado" type="text" hidden>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="TFGModificarEncargado"><strong>Guardar Cambios</strong></button>
                                        <button type="button" data-dismiss="modal" class="btn btn-sm btn-secundary pull-right m-t-n-xs" style="margin-right: 20px;" ><strong>Cancelar</strong></button>
