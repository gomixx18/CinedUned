...
<html>
    ...
    <head>
        ...
        <title>Administración Comisión TFG</title>
        ...
        <div id="wrapper">
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Administración de Miembros de la Comisión TFG</h2>
                        <ol class="breadcrumb">

                            <li class="active">
                                <strong>Consulta de Miembros de la Comisión</strong>
                            </li>
                            <li>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-title">
                                    <h5>Consulta de Miembros de la Comisión</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($connection, "SELECT * FROM tfgmiembroscomision");
            ...
            $(document).ready(function () {
                ...
                $('.dataTables-example').DataTable({
                    ...
                    buttons: [
                        ...
                        {extend: 'csv',
                            title: 'Reporte miembros de Comisión TFG '+ getFecha(),
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4, 5]
                            }
                        },
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Agregar Miembro a la Comisión</h3>
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/TFGagregar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="TFGagregarMiembroComision"><strong>Registrar</strong></button>
        ...
        <div id="mod-form" class="modal fade" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 id="title" class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Modificar Miembro</h3>
