...
<html>
    ...
    <head>
        ...
        <title>Registrar Proyecto de Extensión</title> 
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="admin_Extension.php">Consultar Proyectos de Extensión</a>
                            </li>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                <div class="ibox-title">
                                    <h5>Registrar Nuevo Trabajo de Extensión</h5>
                                </div>
                                <div class="ibox-content">

                                    <form id="form" method="POST" action="funcionalidad/crearExtension.php" class="wizard-big">
                                        <h1>Proyecto de Extensión</h1>
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="nomProyecto" name="titulo" type="text" maxlength="250" class="form-control required">
                                                    </div>
        ...
        <script >
            ...
            $(document).ready(function () {
                ...
                $("#btnAgregarDocenteModal").click(function (evento) {
                    ...
                    table.destroy();
                    $("#tablaDocentes").load("tablas/tablaDocentesExtension.php", {id: idaux, nombre: nomaux, apellido1: ape1aux, apellido2: ape2aux, correo: correoaux, tipo: "docente"}, function () {
