...
<html>
    ...
    <head>
        ...
        <title>Administración de Evaluadores</title>
        ...
        <div id="wrapper">
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Administración de Evaluadores</h2>
                        <ol class="breadcrumb">

                            <li class="active">
                                <strong>Consulta de Evaluadores</strong>
                            </li>
                            <li>
                                <a data-toggle="modal" href="#modal-form">Registrar Evaluador</a>
                            </li>
                ...
                <div class="wrapper wrapper-content animated fadeInRight">
					<a data-toggle="modal" class="btn btn-primary" href="#modal-form">Registrar Evaluador</a>
					<br/>
					<br/>
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($connection, "SELECT * FROM ieevaluadores");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Agregar Evaluador</h3>
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/INVAgregar.php">
                                    <div class="form-group"> <i class="fa fa-exclamation-circle"> <label>Identificacion</label></i> <input name="id" id="id" required type="text" placeholder="Identificacion" class="form-control"></div>
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="INVAgregarEvaluador"><strong>Registar</strong></button>
        ...
        <div id="mod-form" class="modal fade" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Modificar Evaluador</h3>
                                ...
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/INVModificar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-danger pull-left m-t-n-xs" type="button" name="desactivarEvaluador" id="desactivar"><i class="fa fa-warning"></i><strong> Desactivar</strong></button>
                                        <button class="btn btn-sm btn-info pull-left m-t-n-xs" type="button" name="activarEvaluador" id="activar" ><i class="fa fa-check-circle"></i><strong> Activar</strong></button>
                                        <input name="estado" id="estado" type="text" hidden>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="INVModificarEvaluador"><strong>Guardar Cambios</strong></button>
                                        <button type="button" data-dismiss="modal" class="btn btn-sm btn-secundary pull-right m-t-n-xs" style="margin-right: 20px;" ><strong>Cancelar</strong></button>
