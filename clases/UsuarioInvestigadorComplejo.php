...
/**
 * Description of UsuarioInvestigadorComplejo
 *
 * @author JosePablo
 */
class UsuarioInvestigadorComplejo {
    ...
    function __construct($id, $password,$apellido1, $apellido2, $nombre, $correo, $titulo, $especialiad, $isEstudiante) {
